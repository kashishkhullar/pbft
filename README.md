...
*Note the ports are different since all the nodes are run on the same pc and the peers contains a comma seperated list of socket addresses neighbouring nodes*
